    ...
    this.menu = [          

        {
          ...
          items:  [
                ...
                {name:'Category > List > Detail 1 ', component: 'Category1Page'},
                {name:'Category > List > Detail 2',component:'Category2Page'},
                {name:'Category > List > Detail 3',component:'Category3Page'},
                {name:'Feed',component: 'FeedPage'},
                {name:'Form (list)',component: 'FormResultPage'},
                {name:'Google map',component: 'MapPage'},
                {name:'Image gallery',component: 'GalleryPage'},
                {name:'Intro', component:'IntroPage'},
                {name:'Masonry',component: 'MasonryPage'},
