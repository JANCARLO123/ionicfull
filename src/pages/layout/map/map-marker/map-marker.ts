...
export class MapMarkerPage {
  ...
  //******************** Map style  **************************//
  //*****  For more map styles go to snazzymaps.com   ********//
  //**********************************************************//
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public loadingCtrl: LoadingController ,public viewCtrl: ViewController,public database:AngularFireDatabase) {    
    let loadingPopup = this.loadingCtrl.create({
      spinner: 'crescent',
      content: ''
    });
    loadingPopup.present();
    this.database.list('/map').subscribe(mapList => {
        this.items = mapList;
