...
@ViewChild('map') mapElement: ElementRef;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public alertCtrl: AlertController,public modalCtrl: ModalController, public loadingCtrl: LoadingController,private toastCtrl: ToastController,public viewCtrl: ViewController, public database:AngularFireDatabase,private geolocation: Geolocation) {
    ...
    this.mapDetail = database.object("/map/"+this.mapId);
