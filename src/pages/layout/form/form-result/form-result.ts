...
export class FormResultPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams , public loadingCtrl: LoadingController ,private toastCtrl: ToastController ,public database: AngularFireDatabase, public auth : AngularFireAuth) {
    ...
    this.messages = database.list('/message');
