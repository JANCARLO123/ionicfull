...
export class RadioPage {
  ...
  stationUrl: any;
  loadingPopup: any;
  constructor(public navCtrl: NavController, public navParams: NavParams,public modalCtrl: ModalController,public loadingCtrl: LoadingController, public viewCtrl: ViewController , public database:AngularFireDatabase, public myplayer:RadioPlayer, public alertCtrl: AlertController) {
      // radio station list : http://www.radiosure.com/stations/
      this.radioId = this.navParams.get('radioId');
      this.radio = database.object('/radio/'+this.radioId );
