...
export class ChartPage {
    ...
    // shopping cart example :http://stackoverflow.com/questions/38969147/ionic-2-save-and-retrieve-shopping-cart-item-localstorage
    // ref code : http://stackoverflow.com/questions/43034173/how-to-asynchronously-update-values-in-ng2-charts-live-through-firebase

    constructor(public navCtrl: NavController, public database:AngularFireDatabase,public loadingCtrl: LoadingController ) {
    let loadingPopup = this.loadingCtrl.create({
        spinner: 'crescent',
        content: ''
    });
    loadingPopup.present();      
        this.chartList = database.list('/chart', { preserveSnapshot: true });;
        this.chartList
        .subscribe(snapshots => {
