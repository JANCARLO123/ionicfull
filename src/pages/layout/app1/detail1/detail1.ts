...
export class Detail1Page {
  ...
  constructor( public navCtrl: NavController, public navParams: NavParams,public modalCtrl: ModalController,public database:AngularFireDatabase, private toastCtrl: ToastController ,public ref: ChangeDetectorRef) {
    
      this.itemId = this.navParams.get('itemId');
      this.item = database.object('/list/'+this.itemId );
      
      this.itemImages = database.list('/list/'+this.itemId+'/images' );
